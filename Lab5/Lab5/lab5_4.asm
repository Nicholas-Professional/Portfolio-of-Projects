...
;Class#: 12379
;Description: This code grabs the string stored inside of a space in progam memory and outputs the string to the terminal 
*/
...
MAIN:
	...
	ldi r16, 0x3F
	out CPU_SPH, r16
	;Initialize Z to point to the start of the string in program memory 
	ldi ZL, low(String<<1)
	ldi ZH, high(String<<1)
	ldi r16, byte3(String<<1)
	out CPU_RAMPZ, r16
	rcall INIT_GPIO
	rcall INIT_USART
	rcall OUT_STRING
